...
class SafetyIncidentUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'project_id' => ['sometimes', 'required', 'integer', Rule::exists('prj_projects', 'id')],
            ...
            'category' => ['sometimes', 'required', Rule::enum(IncidentCategory::class)],
