...
class DocumentFormatValidationTest extends ErpTestCase
{
     ...
     */
    private const SHIPPED_DOCUMENT_TYPES = 60; // +IKL/ILB/IMK (P0-C) +SDS/SMS/TRM/IPP (P1-ENG) +QCI/NCR (P1-QC) +BAN/AWD/PBL (P2) +OPN/BAPP/BSK (P3) +SP3/OPM (P4) +PPK/PPKB (P5) +HSE (P6) +TND/TKD/RKK/MTD (P7) +OVB (F-2 verifikasi: kodenya harus membawa TAHUN BUKUNYA, jadi formatnya tidak bisa lagi memakai fallback)
